...
PRODUCTS = {
    "ea_list": [
        (
            "GOLDEN Guard Pro EA©",
            {
                ...
                #"3m": ("soon", "80$"), 
                #"6m": ("soon", "150$"), 
                "life": ("https://payhip.com/b/ZlY60", "62$")
            },
        ...
        (
            "GOLDEN ALGO MT5©",
            {
                ...
                #"3m": ("soon", "80$"), 
                #"6m": ("soon", "150$"), 
                "life": ("https://payhip.com/b/ZfUvN", "115$")
            },
        ...
        (
            "Gold Strike EA©",
            {
                ...
                #"3m": ("soon", "70$"), 
                #"6m": ("soon", "130$"), 
                "life": ("https://payhip.com/b/XrvnT", "91.08$")
            },
        ...
        (
            "Prime Trader EA©",
            {
                ...
                #"3m": ("soon", "90$"), 
                #"6m": ("soon", "160$"), 
                "life": ("https://payhip.com/b/CvhyZ", "54.28$")
            },
        ...
        (
            "FOREX Strike EA©",
            {
                ...
                #"3m": ("soon", "55$"), 
                #"6m": ("soon", "100$"), 
                "life": ("https://payhip.com/b/h4Pec", "59.8$")
            },
        ...
        (
            "BitRocket EA MT5©",
            {
                ...
                #"3m": ("soon", "55$"), 
                #"6m": ("soon", "100$"), 
                "life": ("https://payhip.com/b/LdT1V", "59.8$")
            },
    ...
    "ind_list": [
        (
            "Deal Tracker Dashboard©",
            {
                ...
                #"3m": ("soon", "40$"), 
                #"6m": ("soon", "70$"), 
                "life": ("https://payhip.com/b/asW23", "25$")
            },
        ...
        (
            "Trade Vision Panel©",
            {
                ...
                #"3m": ("soon", "40$"), 
                #"6m": ("soon", "70$"), 
                "life": ("https://payhip.com/b/hWJGi", "25$")
            },
        ...
        (
            "RSI Dashboard Pro©",
            {
                ...
                #"3m": ("soon", "25$"), 
                #"6m": ("soon", "45$"), 
                "life": ("https://payhip.com/b/4WcbT", "48.76$")
            },
        ...
        (
            "CrossMaster PRO©",
            {
                ...
                #"3m": ("soon", "30$"), 
                #"6m": ("soon", "50$"), 
                "life": ("https://payhip.com/b/kXdNr", "49.68$")
            },
        ...
        (
            "Trend Vision MT5©",
            {
                ...
                #"3m": ("soon", "20$"), 
                #"6m": ("soon", "35$"), 
                "life": ("https://payhip.com/b/pOdBc", "48.76$")
            },
    ...
    "tools_list": [
        (
            ...
            {
                "life": ("https://payhip.com/b/MV2DL", "45.08$")
            },
        ...
        (
            "Smart Risk Manager©",
            {
                "life": ("https://payhip.com/b/v7O9p", "32.2$")
            },
        ...
        (
            ...
            {
                "life": ("https://payhip.com/b/Chj5F", "45.08$")
            },
    ...
    "free_list": [
        (
            "Candle Close Timer©",
            {"life": ("https://payhip.com/b/0dILl", "FREE")},
        ...
        (
            "FX Clock©",
            {"life": ("https://payhip.com/b/1FUxk", "FREE")},
...
def main_menu_keyboard(user_id, lang):
    ...
    buttons = [
        ...
        [InlineKeyboardButton(t["store_btn"], url="https://payhip.com/BENTRADETrading")],
